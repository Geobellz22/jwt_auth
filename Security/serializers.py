...
class SecuritySerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ip_address_sensitivity = validated_data.get('ip_sensitivity', instance.ip_sensitivity)
        ...
        if ip_address_sensitivity != disabled or detect_device_change:
            ...
            send_mail(
                ...
                message=(
                    f"Someone tried to log in to your account.\n"
        ...
        def validate_pin_code(self, value):
            ...
            if security and security.email_verification_code != value:
                return serializers.ValidationError("Invalid Pin Code")
            return value
